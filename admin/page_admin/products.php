                ...
                <div class="card-body">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination justify-content-end">
                            ...
                            echo '<a class="page-link" href="../index.php?page=products&p=' . ($currentPage - 1) . '">Previous</a>';
                            echo '</li>';

                            for ($i = 1; $i <= $totalPages; $i++) {
                                $activeClass = $i == $currentPage ? 'active' : '';
                                echo '<li class="page-item ' . $activeClass . '">';
                                echo '<a class="page-link" href="../index.php?page=products&p=' . $i . '">' . $i . '</a>';
                                echo '</li>';
                            }

                            $nextClass = $currentPage >= $totalPages ? 'disabled' : '';
                            echo '<li class="page-item ' . $nextClass . '">';
                            echo '<a class="page-link" href="../index.php?page=products&p=' . ($currentPage + 1) . '">Next</a>';
                            echo '</li>';
                            ?>
                        </ul>
                    </nav>
